...
\item Adicionalmente, en el proceso de respuesta del sistema innato y la activación del sistema inmune, tras cualquier conflicto \textit{T vs NK} la célula $NK$ desaparece, cambiando de estado a una celda $CTL$ que permanecerá inactiva durante cierto tiempo. \unsure{V - Aquí he de mirar la bibliografía a ver cuánto tarda en comenzar la respuesta inmune, para poder determinar el número de pasos (en base a las 5h por paso).}\\
